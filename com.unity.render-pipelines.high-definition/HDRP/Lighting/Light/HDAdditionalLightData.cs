...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class HDAdditionalLightData : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        // This function return a mask of light layers as int and handle the case of Everything as being 0xFF and not -1
        public int GetLightLayers()
        {
            int value = Convert.ToInt32(lightLayers);
            return value < 0 ? (int)LightLayerEnum.Everything : value;
        }
